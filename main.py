...
data_manager = DataManager() # instance of the class
...
# ==================== Twilio for msg ====================
    ...
    if cheapest_flight.price != "N/A" and cheapest_flight.price < destination['lowestPrice']:
        print(f"Lowest price flight found to {destination['city']}")
...
# ==================== Twilio for msg ====================
    ...
    if cheapest_flight.price != "N/A" and cheapest_flight.price < destination['lowestPrice']:
        ...
        print(f"Check your email. Low price Flight found to {destination['city']}")
